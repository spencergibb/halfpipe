...
public class Log {
    ...
    /**
     * Returns a {@link Log} instance with the same name as the given Log4j {@link ch.qos.logback.classic.Logger} instance.
     *
     * @param logger    a Log4j {@link ch.qos.logback.classic.Logger}
